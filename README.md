...
When you run the script, the appropriate directory (attendance_tracker_{input}) will be created with its contents, 
which will be copied from the templates folder.
...
However, if you send the signal before specifying the name to attach to your directory, you will receive a message stating that we cannot bundle or archive the directory because it hasn't been created.
